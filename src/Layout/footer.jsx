        ...
        <>
            <div className="bg_black">
                <div className="container mx-auto py-5">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-2 md:py-5">
                        <div className="border-r-2 footer_links">
                        ...
                        <div className="footer_social border-r-2">
                            <h3 className="footer_head">SOCIALS</h3>
                            <ul>
                                <li>
